...
ENV_KEYS = {
    ...
    "HOMEDEPOT_CDP_ENDPOINT": "cdp_endpoint",
    "HOMEDEPOT_PROXY": "proxy",
    "HOMEDEPOT_URL": "url",
}
...
# .env.example documents HOMEDEPOT_CDP_ENDPOINT and HOMEDEPOT_PROXY
...
def duplicate_keys(path=None):
    ...
    2026-09-17 on a fixture with three consecutive HOMEDEPOT_PROXY lines,
...
def unknown_keys(path=None):
    ...
    Usually a typo — `TWO_CAPTCHA_KEY`, `HOMEDEPOT_CDP` — which otherwise fails
